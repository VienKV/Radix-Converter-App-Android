...
public class Conversion {
    ...
    public void chooseConversion() {
        ...
        {
            vn.hust.edu.converterapp.DecimalToAny decimalToAny =new vn.hust.edu.converterapp.DecimalToAny(num,2);
        ...
        else if (from.equals("Hexadecimal") && to.equals("Binary"))
        {
            AnyToDecimal anyToDecimal=new AnyToDecimal(16,num);
            result=anyToDecimal.getRes();
            vn.hust.edu.converterapp.DecimalToAny decimalToAny =new vn.hust.edu.converterapp.DecimalToAny(result,2);
            result= decimalToAny.getRes();
        }
        ...
        else if (from.equals("Decimal") && to.equals("Octal") && validDecimal())   //Done
        {
            vn.hust.edu.converterapp.DecimalToAny decimalToAny =new vn.hust.edu.converterapp.DecimalToAny(num,2);
            result= decimalToAny.getRes();
            vn.hust.edu.converterapp.BinaryToOctal binaryToOctal=new vn.hust.edu.converterapp.BinaryToOctal(result);
            result=binaryToOctal.getRes();

        }
        else if (from.equals("Binary") && to.equals("Octal") && validBinary())
        {
            vn.hust.edu.converterapp.BinaryToOctal binaryToOctal=new vn.hust.edu.converterapp.BinaryToOctal(num);
            result=binaryToOctal.getRes();
        }
        ...
        {
            vn.hust.edu.converterapp.DecimalToAny decimalToAny =new vn.hust.edu.converterapp.DecimalToAny(num,16);
            result= decimalToAny.getRes();
        }
        else if (from.equals("Octal") && to.equals("Hexadecimal")  && validOctal())
        {
            AnyToDecimal anyToDecimal=new AnyToDecimal(8,num);
            result=anyToDecimal.getRes();
            vn.hust.edu.converterapp.DecimalToAny decimalToAny =new vn.hust.edu.converterapp.DecimalToAny(result,16);
            result= decimalToAny.getRes();
